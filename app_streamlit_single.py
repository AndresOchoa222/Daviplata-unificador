...
# ==============================
# Procesador embebido (sin imports locales)
# ==============================
    ...
    for enc in cand_enc:
        for sep in cand_sep:
            try:
                ...
                # Si headers son raros, promueve la primera fila
...
st.set_page_config(page_title="Unificador CSV/XLSX (1 archivo) • robusto", layout="wide")
